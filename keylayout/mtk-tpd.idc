...
touch.filter.RoadRunner.c0.PredictionSteps = 2.2
touch.filter.RoadRunner.c1.PredictionSteps = 3.3
touch.filter.RoadRunner.c2.PredictionSteps = 5.0
touch.filter.RoadRunner.c3.PredictionSteps = 6.6
touch.filter.RoadRunner.FrameRate = 0.0087
